...
if errorlevel 1 (
    if exist %~dp0\..\..\..\..\code\bin\five\debug\F8.com (
        set CFX_CLI=%~dp0\..\..\..\..\code\bin\five\debug\F8.com
        goto :yea
    )

    if exist %LOCALAPPDATA%\F8\F8.app\F8.com (
        set CFX_CLI=%LOCALAPPDATA%\F8\F8.app\F8.com
        goto :yea
    )

    if exist %~dp0\..\..\..\..\code\bin\five\release\F8.com (
        set CFX_CLI=%~dp0\..\..\..\..\code\bin\five\release\F8.com
        goto :yea
    )

    echo Could not find F8.com
    exit /B 1
)
